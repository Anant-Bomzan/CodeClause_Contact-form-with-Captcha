...
<body>
    ...
    <h1>Contact Form</h1>
        <form action="" method="post">
            ...
            <div class="g-recaptcha" data-sitekey="6LeQq-0kAAAAANInlFDtpk47SiPIChtXyXd3vTEE"></div>
        ...
        <div class="status">
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    $to_email='anantmani31@gmail.com';
                    $headers = "From: {$array['username']} <{$array['email']}>\r\n\Reply-To: {$array['email']}";

                    $secretKey="6LeQq-0kAAAAAClKY40h7Y8lgDAUojUuAZMJvXmZ";
